...
public class BackupManagerTest {
    ...
    public void testImportBackupOffering() {
        ...
        BackupOfferingVO offering = new BackupOfferingVO(1L, "external-id", "testbackupprovider", "Test Offering", "Test Description", true, "1");
    ...
    public void testGetBackupStorageUsedStats() {
        Long zoneId = 1L;
        overrideBackupFrameworkConfigValue();
        when(backupManager.getBackupProvider("testProvider")).thenReturn(backupProvider);

...
public class ApiServer extends ManagerBase implements HttpRequestHandler, ApiServerService, Configurable {
    protected static Logger logger = LogManager.getLogger(ApiServer.class.getName());
    protected static Logger s_accessLogger = LogManager.getLogger("apiserver." + ApiServer.class.getName());
    ...
    public ResponseObject loginUser(final HttpSession session, final String username, final String password, Long domainId, final String domainPath, final InetAddress loginIpAddress,
        ...
        if (ApiServer.SecurityFeaturesEnabled.value()) {
            ...
            try {
                ...
                userAcct = accountMgr.authenticateUser(username, null, domainId, loginIpAddress, requestParameters);
            }

...
public enum Config {
    ...
    NetworkLBHaproxyClientTimeout(
            ...
            ManagementServer.class,
            Integer.class,
            "network.loadbalancer.haproxy.client.timeout",
            "50000",
            "Load Balancer(haproxy) client timeout in milliseconds.",
            null),
    NetworkLBHaproxyConnectTimeout(
            "Network",
            ManagementServer.class,
            Integer.class,
            "network.loadbalancer.haproxy.connect.timeout",
            "5000",
            "Load Balancer(haproxy) connect timeout in milliseconds.",
            null),
    NetworkLBHaproxyServerTimeout(
            "Network",
            ManagementServer.class,
            Integer.class,
            "network.loadbalancer.haproxy.server.timeout",
            "50000",
            "Load Balancer(haproxy) server timeout in milliseconds.",
            null),

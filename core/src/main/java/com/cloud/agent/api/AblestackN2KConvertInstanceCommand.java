...
public class AblestackN2KConvertInstanceCommand extends Command {

    private String vmName;
    private String prismEndpoint;
    ...
    public AblestackN2KConvertInstanceCommand(String vmName, String prismEndpoint, String username, String password,
                                              DataStoreTO targetStorageLocation, String splitMode, String sourceApi,
                                              boolean insecure, String workdir) {
        this.vmName = vmName;
    ...
    public String getPrismEndpoint() {

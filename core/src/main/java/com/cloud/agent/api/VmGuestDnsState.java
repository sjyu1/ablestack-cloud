...
public class VmGuestDnsState {
    private List<String> servers;
    private List<String> searchDomains;
    private String source;
    private boolean upstreamServersKnown;
    private List<VmGuestDnsConfig> configurations;

    public VmGuestDnsState() {
    ...
    public List<VmGuestDnsConfig> getConfigurations() {
        return configurations;
    }

    public void setConfigurations(List<VmGuestDnsConfig> configurations) {

...
public class DirectDownloadHelper {
    ...
    protected static Logger LOGGER = LogManager.getLogger(DirectDownloadHelper.class.getName());
    ...
    public static boolean checkUrlExistence(String url, Integer connectTimeout, Integer connectionRequestTimeout, Integer socketTimeout) {
        try {
            ...
            LOGGER.error(String.format("URL에 대한 다운로드 검사기를 찾을 수 없습니다: %s", url, e.getMessage()), e);
            return false;
        }
    }

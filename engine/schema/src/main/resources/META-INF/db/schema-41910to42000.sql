...
CREATE TABLE IF NOT EXISTS `cloud`.`shared_filesystem`(
    ...
    `network_mode` varchar(16) NOT NULL DEFAULT 'DHCP' COMMENT 'SharedFS VM network addressing mode',
    `ip_address` varchar(45) DEFAULT NULL COMMENT 'Requested static IPv4 address',
    `cidr` varchar(45) DEFAULT NULL COMMENT 'Requested static IPv4 CIDR',
    `gateway` varchar(45) DEFAULT NULL COMMENT 'Requested static IPv4 gateway',
    `dns1` varchar(45) DEFAULT NULL COMMENT 'Requested primary DNS server',
    `dns2` varchar(45) DEFAULT NULL COMMENT 'Requested secondary DNS server',

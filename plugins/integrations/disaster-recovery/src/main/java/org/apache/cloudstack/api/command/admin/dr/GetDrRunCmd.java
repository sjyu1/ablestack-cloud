...
@APICommand(name = GetDrRunCmd.APINAME, description = "Get a DR run", responseObject = DrRunResponse.class,
        responseView = ResponseObject.ResponseView.Full, authorized = {RoleType.Admin})
public class GetDrRunCmd extends BaseCmd {
    public static final String APINAME = "getDrRun";
    ...
    public void execute() throws ServerApiException {
        try {
            DrRunVO run = drRunService.getRun(id);

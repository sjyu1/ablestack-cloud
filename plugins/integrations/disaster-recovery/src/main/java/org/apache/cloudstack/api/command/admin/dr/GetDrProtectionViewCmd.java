...
@APICommand(name = GetDrProtectionViewCmd.APINAME, description = "Get the cached DR protection view",
        responseObject = DrProtectionViewResponse.class, authorized = {RoleType.Admin})
public class GetDrProtectionViewCmd extends BaseCmd {
    public static final String APINAME = "getDrProtectionView";
    ...
    public void execute() throws ServerApiException {
        try {
            DrProtectionViewResponse response = DrProtectionViewResponse.from(drProtectionViewService.getProtectionView(planId));

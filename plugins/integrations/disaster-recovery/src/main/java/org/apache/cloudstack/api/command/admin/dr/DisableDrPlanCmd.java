...
@APICommand(name = DisableDrPlanCmd.APINAME, description = "Disable a DR plan", responseObject = DrPlanResponse.class, authorized = {RoleType.Admin})
public class DisableDrPlanCmd extends BaseAsyncCmd {
    public static final String APINAME = "disableDrPlan";

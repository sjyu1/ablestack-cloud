...
public class DrActionAvailability {
    private final boolean applicable;
    private final boolean enabled;
    private final String reasonCode;
    private final Map<String, String> reasonArgs;

    public DrActionAvailability(boolean applicable, boolean enabled, String reasonCode,
    ...
    public Map<String, String> getReasonArgs() {
        return reasonArgs;
    }
}

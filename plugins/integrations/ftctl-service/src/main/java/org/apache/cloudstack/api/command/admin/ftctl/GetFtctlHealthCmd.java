...
@APICommand(name = GetFtctlHealthCmd.APINAME,
        description = "Gets FTCTL health for the host backing a virtual machine",
        responseObject = FtctlHealthResponse.class,
        responseView = ResponseObject.ResponseView.Full,
        authorized = {RoleType.Admin})
public class GetFtctlHealthCmd extends BaseCmd {
    public static final String APINAME = "getFtctlHealth";
    ...
    public void execute() throws ServerApiException {
        FtctlHealthResponse response = ftctlService.getFtctlHealth(this);

...
public class FtctlProtectionProvisioningContext {
    ...
    public FtctlProtectionProvisioningContext(String provisioningBackend, String provisioningState, String secondaryVmName, String diskMap) {

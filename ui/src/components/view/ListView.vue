...
<template>
  <a-table
    ...
    :pagination="false"
    :rowSelection=" enableGroupAction() || ($route.name === 'event' && !$store.getters.features.securityfeaturesenabled) ? {selectedRowKeys: selectedRowKeys, onChange: onSelectChange, columnWidth: 30} : null"

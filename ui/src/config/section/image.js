...
export default {
  ...
  children: [
    ...
    //     return fields
    //   },
    //   details: ['name', 'id', 'displaytext', 'checksum', 'ostypename', 'size', 'bootable', 'isready', 'passwordenabled', 'directdownload', 'isextractable', 'ispublic', 'isfeatured', 'crosszones', 'account', 'domain', 'created', 'isdynamicallyscalable', 'userdatadetails', 'userdatapolicy', 'url'],
    //   searchFilters: () => {
    //     var filters = ['name', 'zoneid', 'tags']
    //     if (['Admin', 'DomainAdmin'].includes(store.getters.userInfo.roletype)) {
    //       filters.push('storageid')

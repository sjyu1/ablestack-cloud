...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      filters: ['active', 'inactive'],
      details: ['name', 'id', 'displaytext', 'systemvmtype', 'provisioningtype', 'cachemode', 'storagetype', 'iscustomized', 'limitcpuuse', 'cpunumber', 'cpuspeed', 'memory', 'storagetags', 'hosttags', 'tags', 'domain', 'zone', 'created', 'dynamicscalingenabled', 'diskofferingstrictness'],
      resourceType: 'ServiceOffering',
      tabs: [
        {
          name: 'details',
    ...
    },
    {
      ...
      columns: ['name', 'displaytext', 'state', 'disksize', 'domain', 'zone', 'kvdoenable', 'order'],
      filters: ['active', 'inactive'],
      details: () => {
        var fields = ['name', 'id', 'displaytext', 'disksize', 'provisioningtype', 'storagetype', 'iscustomized', 'disksizestrictness', 'iscustomizediops',
          ...
          'domain', 'zone', 'created', 'encrypt', 'shareable', 'kvdoenable']
    ...
    },
    {
      ...
      details: ['name', 'id', 'description', 'externalid', 'retentionperiod', 'domain', 'zone', 'allowuserdrivenbackups', 'created'],
      related: [{
        name: 'vm',
        title: 'label.instances',

  ...
  children: [
    {
      ...
      columns: () => {
        ...
        var fields = ['name', 'state', 'type', 'cidr', 'ip6cidr', 'broadcasturi', 'domainpath']
        if (!isAdmin()) {
      ...
      details: () => {
        ...
        var fields = ['name', 'id', 'description', 'type', 'traffictype', 'vlan', 'broadcasturi', 'cidr', 'ip6cidr', 'netmask', 'gateway', 'aclname', 'ispersistent', 'restartrequired', 'reservediprange', 'redundantrouter', 'networkdomain', 'egressdefaultpolicy', 'zonename', 'account', 'domainpath', 'associatednetwork', 'associatednetworkid', 'ip6firewall', 'ip6routing', 'ip6routes', 'dns1', 'dns2', 'ip6dns1', 'ip6dns2', 'publicmtu', 'privatemtu']
        if (!isAdmin()) {
          fields = fields.filter(function (e) { return e !== 'broadcasturi' })
        }
        return fields
    ...
    //   columns: ['vlan', 'allocationstate', 'physicalnetworkname', 'taken', 'account', 'domain', 'zonename'],
    //   // details: ['vlan', 'allocationstate', 'physicalnetworkname', 'taken', 'account', 'project', 'domain', 'isdedicated', 'zonename'],
    //   details: ['vlan', 'allocationstate', 'physicalnetworkname', 'taken', 'account', 'domain', 'isdedicated', 'zonename'],

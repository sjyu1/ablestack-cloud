...
@APICommand(name = "deleteStorageIscsiTarget",
...
public class DeleteStorageIscsiTargetCmd extends BaseAsyncCmd implements UserCmd {
    @Inject
    ...
    public String getEventType() {
        return "STORAGE.ISCSI.TARGET.DELETE";
    }

    @Override
    public String getEventDescription() {
        return "Deleting Storage Service iSCSI target " + id;
    }

    @Override
    public void execute() {
        SuccessResponse response = new SuccessResponse(getCommandName());
        response.setSuccess(storageService.deleteStorageIscsiTarget(this));

...
@APICommand(name = "listStorageServiceDomainStatus",
        responseObject = StorageIdentityDomainResponse.class,
        description = "Lists SMB identity domain join status for Storage Service instances.",
        requestHasSensitiveInfo = false,
        responseHasSensitiveInfo = false,
        since = "4.21.0",
        authorized = {RoleType.Admin, RoleType.ResourceAdmin, RoleType.DomainAdmin, RoleType.User})
public class ListStorageServiceDomainStatusCmd extends BaseListCmd implements UserCmd {
    @Inject
    ...
    @Override
    public void execute() {
        ListResponse<StorageIdentityDomainResponse> response = storageService.listStorageServiceDomainStatus(this);

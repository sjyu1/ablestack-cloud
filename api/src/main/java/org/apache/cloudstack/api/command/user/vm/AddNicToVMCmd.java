...
public class AddNicToVMCmd extends BaseAsyncCmd implements UserCmd {
    protected static Logger logger = LogManager.getLogger(AddNicToVMCmd.class);
    ...
    @Override
    public void execute() {
        CallContext.current().setEventDetails("가상머신 Id: " + this._uuidMgr.getUuid(VirtualMachine.class, getVmId()) + ", 네트워크 Id: " + this._uuidMgr.getUuid(Network.class, getNetworkId()));

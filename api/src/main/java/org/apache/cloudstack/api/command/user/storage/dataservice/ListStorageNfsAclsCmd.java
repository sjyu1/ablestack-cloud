...
@APICommand(name = "listStorageNfsAcls",
        ...
        description = "Lists NFS ACL rules.",
        requestHasSensitiveInfo = false,
        responseHasSensitiveInfo = false,
        since = "4.21.0",
        authorized = {RoleType.Admin, RoleType.ResourceAdmin, RoleType.DomainAdmin, RoleType.User})
public class ListStorageNfsAclsCmd extends BaseListCmd implements UserCmd {
    @Inject
    ...
    @Override
    public void execute() {
        ListResponse<StorageAccessRuleResponse> response = storageService.listStorageNfsAcls(this);

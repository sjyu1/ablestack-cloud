...
@APICommand(name = "deleteStorageNfsExport",
...
public class DeleteStorageNfsExportCmd extends BaseAsyncCmd implements UserCmd {
    @Inject
    ...
    public String getEventType() {
        return "STORAGE.NFS.EXPORT.DELETE";
    }

    @Override
    public String getEventDescription() {
        return "Deleting Storage Service NFS export " + id;
    }

    @Override
    public void execute() {
        boolean result = storageService.deleteStorageNfsExport(this);

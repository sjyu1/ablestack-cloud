...
@APICommand(name = "listStorageServiceInventory",
        responseObject = StorageServiceRuntimeResponse.class,
        description = "Lists runtime inventory for Storage Service instances.",
        requestHasSensitiveInfo = false,
        responseHasSensitiveInfo = false,
        since = "4.21.0",
        authorized = {RoleType.Admin, RoleType.ResourceAdmin, RoleType.DomainAdmin, RoleType.User})
public class ListStorageServiceInventoryCmd extends BaseListCmd implements UserCmd {
    @Inject
    ...
    @Override
    public void execute() {
        ListResponse<StorageServiceRuntimeResponse> response = storageService.listStorageServiceInventory(this);

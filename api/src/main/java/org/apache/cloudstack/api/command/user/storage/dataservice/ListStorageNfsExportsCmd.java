...
@APICommand(name = "listStorageNfsExports",
        responseObject = StorageNfsExportResponse.class,
        description = "Lists NFS exports.",
        requestHasSensitiveInfo = false,
        responseHasSensitiveInfo = false,
        since = "4.21.0",
        authorized = {RoleType.Admin, RoleType.ResourceAdmin, RoleType.DomainAdmin, RoleType.User})
public class ListStorageNfsExportsCmd extends BaseListCmd implements UserCmd {
    @Inject
    StorageService storageService;

    @Parameter(name = ApiConstants.ID, type = CommandType.UUID, entityType = StorageNfsExportResponse.class, description = "NFS export ID")
    private Long id;
    ...
    @Override
    public void execute() {
        ListResponse<StorageNfsExportResponse> response = storageService.listStorageNfsExports(this);

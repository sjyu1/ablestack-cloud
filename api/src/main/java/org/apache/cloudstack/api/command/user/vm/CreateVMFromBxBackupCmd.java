...
@APICommand(name = "createVMFromBxBackup",
...
public class CreateVMFromBxBackupCmd extends BaseCmd {
    ...
    public void execute () {
        ...
        try {
            result = _userVmService.restoreVMFromBxBackup(this);
        ...
        if (result != null && Boolean.TRUE.equals(result.first())) {
            ...
            String message = result != null ? result.second() : null;
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR,
                    message != null ? message : "Failed to create VM from BX backup");
        }
    }

...
@APICommand(name = "listStorageNvmeOfSubsystems",
        ...
        description = "Lists NVMe-oF subsystems and namespaces.",
...
public class ListStorageNvmeOfSubsystemsCmd extends BaseListCmd implements UserCmd {
    ...
    @Parameter(name = ApiConstants.ID, type = CommandType.UUID, entityType = StorageBlockTargetResponse.class, description = "NVMe-oF subsystem or namespace ID")
    private Long id;
